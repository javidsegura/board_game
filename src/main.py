...
class CasinoMines(QWidget, GameStyle):
    ...
    def __init__(self):
        ...
        self.main_layout.addWidget(self.header.setup_header())
    ...
    def configuration_panel(self) -> None:
        ...
        self.start_button.setDisabled(False)  # Disabled initially
    ...
    def game_over(self):
       ...
       # Deactivate corresponding widgets of the GUI
        ...
        QTimer.singleShot(3000, self.game_over_reset)
